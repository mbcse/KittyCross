...
const kittydeets = {
    ...
    genes: '338635910126578066514989357798569375861404721347333941257145493487751203', // Represented as a string
  };
export default function  test() {
    return (
        <KittyCard chainId={1} kittyId={"1223"} kitty={kittydeets} />
    )
}