...
contract KittyBreeding is KittyERC721, IMessageRecipient {
    ...
    /// @dev This cannot be used in cross-chain functionality because you don't know whether the sire is owned by the same account
...
*/// @title A title that should describe the contract/interface
    ...
    function giveBirthCrossChain(uint256 _matronId)
        external
        whenNotPaused
        returns(uint256)
    {
